    ...
    <View style={[styles.container, { width: size, height: size }]}>
      ...
      <View style={styles.overlay}>
        <View style={styles.bpmContainer}>
          <Text style={[styles.bpmValue, { fontSize: clamp(size * 0.13, 14, 22) }]}>
            {bpm.toFixed(1)}
          </Text>
          <Text style={[styles.bpmLabel, { fontSize: clamp(size * 0.04, 7, 9) }]}>
            BPM
          </Text>
        </View>
        {pitchPercent !== 0 && (
          <Text style={[styles.pitchText, { fontSize: clamp(size * 0.05, 9, 12) }]}>
            {pitchPercent > 0 ? "+" : ""}
