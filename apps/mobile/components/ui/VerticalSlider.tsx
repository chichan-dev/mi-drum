...
export default function VerticalSlider({
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Zona táctil del slider: sin overflow, para que el thumb pueda
          sobresalir del track sin recortarse */}
      <View
        ref={trackRef}
      ...
      >
        {/* Track: recorta el relleno para que nunca se salga del cuerpo del fader */}
